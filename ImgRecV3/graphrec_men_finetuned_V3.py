...
print('*** Men Dataset Fine tuned ResNet features LR 0.00005 reg 0.0001 load the weights linear activation  NEW Fine tuning last 50 layer***')
############################      Read Data     #####################################
...
image_features_embedding=keras.layers.Dense(image_embedding,activation='relu')(images_features)
...
model.save_weights('/ImageRec/Men/my_checkpoint_Men')
print('model saved...')
#print(model.summary()) 
##### Testing ########
